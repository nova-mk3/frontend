...
export default function MemberCard({
  ...
  if (type === "small") {
    return (
      <div
        onClick={onClick}
        className={`w-[200px] h-[80px] m-[8px] flex border border-primary rounded-lg items-center hover:bg-background02 cursor-pointer`}
      >
        {/* <Image
          src={TempImageLink}
          alt="profileImage"
    ...
    return (
      <div
        onClick={onClick}
        className={`w-[600px] h-[80px] m-[8px] flex border border-primary rounded-lg items-center hover:bg-background02 cursor-pointer`}
      >
        {/* <Image
          src={TempImageLink}
          alt="profileImage"
    ...
    return (
      <div
        className={`w-[700px] h-[80px] m-[8px] flex border border-primary rounded-lg items-center hover:bg-background02 cursor-pointer`}
      >
        {/* <Image
          src={TempImageLink}
          alt="profileImage"
    ...
    return (
      <div
        onClick={onClick}
        className={`w-[1400px] h-[160px] m-[8px] flex border border-primary rounded-lg items-center hover:bg-background02 cursor-pointer`}
      >
        {/* <Image
          src={TempImageLink}
          alt="profileImage"
