...
export const AlretModalContent = ({
  children,
  className,
}: AlretModalContentProps) => {
...
export const AlretModalCancel = ({
  children,
  className,
  onClick,
}: AlretModalCancelProps) => {
  ...
  return (
    <Button variant={"text"} className={cn(className)} onClick={handleonClick}>
      {children}
    </Button>
  );
};
...
export const AlretModalAction = ({
  children,
  className,
  onClick,
}: AlretModalActionProps) => {
