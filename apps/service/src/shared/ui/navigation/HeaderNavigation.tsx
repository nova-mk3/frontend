  ...
  return (
    <NavigationMenu className="z-[40]">
      <NavigationMenuList className="gap-[20px]">
        <NavigationMenuItem>
          <NavigationMenuTrigger className="t-m">소개</NavigationMenuTrigger>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="t-m">게시판</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="flex flex-col gap-[15px] p-4 md:w-[325px] lg:grid-cols-[.75fr_1fr] bg-background01">
              <NavigationMenuLink asChild>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="t-m">가이드</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="flex flex-col gap-[15px] p-4 md:w-[325px] lg:grid-cols-[.75fr_1fr] bg-background01">
              <NavigationMenuLink asChild>
                <Link
