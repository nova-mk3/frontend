...
export default function FramePictureSection({
  ...
  return (
    <div className={cn(className)} {...props}>
      ...
      <div className="d-l  mt-4 mb-4 text-center ">CBNU software club NOVA</div>
      <div className="relative w-screen flex justify-center">
        <DotGrid />
        <Frame className="relative w-[1400px] h-[1100px] mobile:hidden" />
        <FrameMobile className="hidden mobile:flex" />
      </div>
    </div>
  );
}
