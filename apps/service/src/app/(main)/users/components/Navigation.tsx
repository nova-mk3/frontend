  ...
  return (
    <div className=''>
      <ul className='flex flex-row gap-7 flex-wrap mx-auto justify-center border-b-[1px] border-line01'>
        <NavigationMenuItem href="edit">
        회원정보수정
        </NavigationMenuItem>
        <NavigationMenuItem href="pwd">
         비밀번호 변경
        </NavigationMenuItem>
...
export function NavigationMenuItem({ children, href, className }: ItemsProps) {
  ...
  return (
    <Link href={href}>
      <li
        className={`${
          isActive ? "text-primary after:content-[''] after:absolute after:w-full  after:h-[4px] after:bg-primary after:left-0 after:bottom-0" : 'hover:text-primary text-text01'
