...
export default function ModifyFileUploader({selectedFiles,setSelectedFiles,setOriginFiles,originFiles,setwillDeleteFiles} : props) {
        ...
        <div className='flex flex-row flex-wrap gap-3'>
            {
                originFiles.map( (file )=>(
                    <ModifyFileItem downloadUrl={file.downloadUrl} id={file.id} originalFileName={file.originalFileName} onRemove={handleRemoveFiles} key={file.id}/> 
                ))
            }
