...
export default function SuggestionList({ content }: SuggestionListProps) {
  return (
    <div className="flex flex-col gap-2 min-h-[700px] mobile:pt-5">
      <div className="flex flex-row t-m border-y-[1px] border-line01 py-2 mt-5 mobile:hidden">
        <p className="text-center pl-5">제목</p>
